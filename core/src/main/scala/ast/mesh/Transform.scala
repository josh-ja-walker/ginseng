...
// type Positions[N <: Int] = Mat[4, N]

// given [N <: Int] => ValueOf[N] => Transform[Positions[N]] {
//     extension (v: Positions[N]) 
//         def transform(t: Transformation): Positions[N] = {
//             t.mat * v
//         }
// }


// given matTransform: [N <: Int, M] => ValueOf[N] => ToMat[N, M] => (f: FromMat[N, M]) => Transform[M] {
//     extension (v: M) 
//         def transform(t: Transformation): M = f.fromMat(t.mat * v.toMat)
// }
